...
class ActionEffect():
    def __init__(self):
        system_path = "gpt_path/planner/action_effect/system_prompts/system.txt"
        example_path = 'gpt_path/planner/action_effect/system_prompts/example_planner.json'
        self.gpt = ChatGPT(method="AE", system_path=system_path, example_path=example_path)
